...
return {
  ...
  opts = {
    workspaces = {
      {
        name = 'notes',
        path = '/Users/martinhauke/Library/Mobile Documents/iCloud~md~obsidian/Documents/notes',
      },
    },
    -- Keep notes in a specific subdirectory
    notes_subdir = 'notes',
    ...
    templates = {
      ...
      substitutions = {
        date_with_day = function()
          return tostring(os.date '%d.%m.%Y - %A')
        end,
      },
    },
    ...
    -- We use render-markdown.nvim instead
    ui = {
      enable = false,
    },
